...
Route::group(['middleware'=>['auth','roleaccess:administrator']], function(){
    ...
    Route::get('/data_pengguna/export_pdf', [DataPenggunaController::class, 'export_pdf'])->name('data_pengguna.export_pdf')->middleware(['auth','roleaccess:administrator,operatpengguna']);   
});
